import { a as $, K as Ki, i as hl, d as b$1, B as Bi, c as as, S as Ss, j as be$1, Q as Qt, k as wl, l as ie, s as ss, m as Rl, n as yl, X as Xi, y as yr, o as Xe, U as Ul, p as ml, w as w$1, z as zl, q as Bl, M as Ml, t as sl, v as ol, x as xl } from "./indexhtml-CZ8u1Gs0.js";
import { g as g$1, h } from "./state-gDe32brS-CF468KOB.js";
import { p as p$1, y } from "./overlay-monkeypatch-B9_qj2hR-BqycwZtV.js";
import { r as r$1 } from "./icons-B5-WIrwf-CIVkJpdj.js";
import { K as K$1 } from "./react-utils-DFD62MFY-DV-Nu30T.js";
import { showNotification as N$1, dismissNotification as m$1 } from "./copilot-notification-CBGhtEfc-iwwtb0VG.js";
/**
 * @license
...
let b = class extends Ss {
    ...
    super(...arguments), this.position = "right", this.opened = false, this.keepOpen = false, this.resizing = false, this.closingForcefully = false, this.draggingSectionPanel = null, this.activationAnimationTransitionEndListener = () => {
      ...
      e.stopPropagation(), e.preventDefault(), requestAnimationFrame(() => {
        ...
        if (this.position === "right") {
          ...
          this.style.setProperty("--size", `${i}px`), be$1.saveDrawerSize(this.position, i), n = { width: i };
        } else if (this.position === "left") {
          const i = t;
          this.style.setProperty("--size", `${i}px`), be$1.saveDrawerSize(this.position, i), n = { width: i };
        } else if (this.position === "bottom") {
          const i = document.body.clientHeight - o;
          this.style.setProperty("--size", `${i}px`), be$1.saveDrawerSize(this.position, i), n = { height: i };
        }
        Qt.panels.filter((i) => !i.floating && i.panel === this.position).forEach((i) => {
          Qt.updatePanel(i.tag, n);
        });
      });
    }, this.sectionPanelDraggingStarted = (e, t) => {
      this.draggingSectionPanel = e, $.emit("user-select", { allowSelection: false }), this.draggingSectionPointerStartY = t.clientY, e.toggleAttribute("dragging", true), e.style.zIndex = "1000", Array.from(this.querySelectorAll("copilot-section-panel-wrapper")).forEach((o, n) => {
        o.setAttribute(B, `${n}`);
      ...
      if (!wl(this.getBoundingClientRect(), t, o)) {
      ...
      this.cleanUpDragging(), Qt.updateOrders(e), document.removeEventListener("mouseup", this.sectionPanelDraggingFinished), document.removeEventListener("mousemove", this.sectionPanelDragging);
  ...
  connectedCallback() {
    super.connectedCallback(), this.reaction(
      ...
      (t) => {
        t === Rl.DragAndDrop && !this.opened && !this.keepOpen ? this.style.setProperty("pointer-events", "none") : this.style.setProperty("pointer-events", "auto");
      }
    ), this.reaction(
      () => Qt.getAttentionRequiredPanelConfiguration(),
      () => {
        const t = Qt.getAttentionRequiredPanelConfiguration();
        t && !t.floating && this.toggleAttribute(yl, t.panel === this.position);
      }
    ), this.reaction(
      () => b$1.active,
      () => {
        if (!b$1.active || !Xi.isActivationAnimation() || b$1.activatedFrom === "restore" || b$1.activatedFrom === "test")
          return;
        const t = Qt.getAttentionRequiredPanelConfiguration();
    ...
    const e = be$1.getDrawerSize(this.position);
    e && this.style.setProperty("--size", `${e}px`), document.addEventListener("mousemove", this.resizingMouseMoveListener), this.addEventListener("mouseenter", this.mouseEnterListener), $.on("document-activation-change", (t) => {
  ...
  firstUpdated(e) {
    super.firstUpdated(e), requestAnimationFrame(() => this.toggleAttribute("no-transition", false)), this.resizeElement.addEventListener("mousedown", (t) => {
      t.button === 0 && (this.resizing = true, b$1.setDrawerResizing(true), this.setAttribute("resizing", ""), $.emit("user-select", { allowSelection: false }));
    });
  }
  updated(e) {
    super.updated(e), e.has("opened") && this.opened && this.hasAttribute(yl) && (this.removeAttribute(yl), Qt.clearAttention()), this.updateScrollable();
  }
...
class me {
  ...
  dragging(t, o) {
    const n = o.clientX, i = o.clientY, r = n - this.offsetX, s = n - this.offsetX + t.getBoundingClientRect().width, c = i - this.offsetY, h2 = i - this.offsetY + t.getBoundingClientRect().height;
    return this.adjust(t, r, c, s, h2);
  }
  adjust(t, o, n, i, r) {
    let s, c, h2, P;
    const I = document.documentElement.getBoundingClientRect().width, C = document.documentElement.getBoundingClientRect().height;
    return (i + o) / 2 < I / 2 ? (t.style.setProperty("--left", `${o}px`), t.style.setProperty("--right", ""), P = void 0, s = Math.max(0, o)) : (t.style.removeProperty("--left"), t.style.setProperty("--right", `${I - i}px`), s = void 0, P = Math.max(0, I - i)), (n + r) / 2 < C / 2 ? (t.style.setProperty("--top", `${n}px`), t.style.setProperty("--bottom", ""), h2 = void 0, c = Math.max(0, n)) : (t.style.setProperty("--top", ""), t.style.setProperty("--bottom", `${C - r}px`), c = void 0, h2 = Math.max(0, C - r)), {
      left: s,
      right: P,
      top: c,
      bottom: h2
...
let T = class extends Ss {
  constructor() {
    super(...arguments), this.initialMouseDownPosition = null, this.dragging = false, this.mouseDownListener = (e) => {
      ...
      this.dragging && (this.setOverlayVisibility(false), m.dragging(this, e));
    }, this.documentMouseUpListener = (e) => {
      if (this.dragging) {
        const t = m.dragging(this, e);
        Xi.setActivationButtonPosition(t), this.setOverlayVisibility(true);
      }
      ...
      return e ? e.panel && !e.floating ? ($.emit("open-attention-required-drawer", null), true) : (Qt.clearAttention(), true) : false;
  ...
  connectedCallback() {
    super.connectedCallback(), this.reaction(
      () => Qt.attentionRequiredPanelTag,
      () => {
        this.toggleAttribute(yl, Qt.attentionRequiredPanelTag !== null);
      }
    ), this.reaction(
      () => b$1.active,
      () => {
    ...
    const e = Xi.getActivationButtonPosition();
    e ? (this.style.setProperty("--left", `${e.left}px`), this.style.setProperty("--bottom", `${e.bottom}px`), this.style.setProperty("--right", `${e.right}px`), this.style.setProperty("--top", `${e.top}px`)) : (this.style.setProperty("--bottom", "var(--space)"), this.style.setProperty("--right", "var(--space)")), $.on("document-activation-change", (t) => {
      this.toggleAttribute("document-hidden", !t.detail.active);
    });
  }
  disconnectedCallback() {
  ...
  render() {
        ...
        children: [
          {
            component: p("vaadin-menu-bar-item", {
              ...
              hint: Xi.isActivationShortcut() ? Ul.toggleCopilot : void 0
            }),
            action: "copilot"
          },
          {
    ...
    return b$1.active && (b$1.idePluginState?.supportedActions?.find((t) => t === "undo") && (e[0].children = [
      {
        component: p("vaadin-menu-bar-item", {
          label: "Undo",
          hint: Ul.undo
        ...
        children: [
          {
            component: p("vaadin-menu-bar-item", {
              ...
              hint: Xi.isActivationShortcut() ? "✓" : void 0
            }),
            action: "shortcut"
          },
          {
            component: p("vaadin-menu-bar-item", {
              ...
              hint: Xi.isActivationAnimation() ? "✓" : void 0
            }),
  ...
  handleMenuItemClick(e) {
    switch (e.action) {
      ...
      case "spotlight":
        ...
        break;
      case "shortcut":
        Xi.setActivationShortcut(!Xi.isActivationShortcut());
        break;
      case "animate-on-activate":
        Xi.setActivationAnimation(!Xi.isActivationAnimation());
        break;
      case "undo":
      case "redo":
        $.emit("undoRedo", { undo: e.action === "undo" });
        break;
      case "feedback":
        Qt.updatePanel("copilot-feedback-panel", {
          floating: true
        });
        break;
      case "welcome":
        ...
        break;
      case "shortcuts":
        Qt.updatePanel("copilot-shortcuts-panel", {
          floating: true
        });
        break;
    }
...
let w = class extends Ss {
  constructor() {
    super(...arguments), this.panelTag = "", this.dockingItems = [
      ...
      this.hasAttribute(_) && (e.stopPropagation(), e.preventDefault(), m.anchorLeftTop(this), this.floatingResizingStarted = true, this.toggleAttribute("resizing", true), ml(() => {
      ...
      if (!this.floatingResizingStarted || !this.panelInfo?.floating)
        return;
      e.stopPropagation(), e.preventDefault(), this.floatingResizingStarted = false, ml(() => {
        b$1.sectionPanelResizing = false;
      });
      const { width: t, height: o } = this.getBoundingClientRect(), { left: n, top: i, bottom: r, right: s } = m.anchor(this), c = window.getComputedStyle(this.container), h2 = Number.parseInt(c.borderTopWidth, 10), P = Number.parseInt(c.borderTopWidth, 10);
      Qt.updatePanel(this.panelInfo.tag, {
        width: t,
        height: o - (h2 + P),
        floatingPosition: {
      ...
      e.button === 0 && (this.resizingInDrawerStarted = true, this.setAttribute("resizing", ""), $.emit("user-select", { allowSelection: false }));
      ...
      this.style.setProperty("--section-height", `${o}px`), Qt.updatePanel(this.panelInfo.tag, {
        height: o
      });
      ...
      this.hasAttribute(yl) && (this.removeAttribute(yl), Qt.clearAttention());
    }, this.contentAreaMouseDownListener = () => {
      Qt.addFocusedFloatingPanel(this.panelInfo);
      ...
      e.button === 0 && (Qt.addFocusedFloatingPanel(this.panelInfo), !this.hasAttribute(g) && (e.target instanceof HTMLButtonElement && e.target.getAttribute("part") === "title-button" ? this.startDraggingDebounce(e) : this.startDragging(e)));
    }, this.startDragging = (e) => {
      m.draggingStarts(this, e), document.addEventListener("mousemove", this.draggingEventListener), b$1.setSectionPanelDragging(true), this.panelInfo?.floating ? this.toggleAttribute("dragging", true) : this.parentElement.sectionPanelDraggingStarted(this, e), e.preventDefault(), e.stopPropagation();
    }, this.startDraggingDebounce = hl(this.startDragging, 200), this.draggingEventListener = (e) => {
      const t = m.dragging(this, e);
      ...
      const e = Qt.getPanelByTag(this.panelTag);
      ...
      if (!this.panelInfo)
        return w$1;
      let e;
      return this.panelInfo.panel === void 0 ? e = "Close the popup" : e = this.panelInfo.floating ? `Dock ${this.panelInfo.header} to ${this.panelInfo.panel}` : `Open ${this.panelInfo.header} as a popup`, yr`
    ...
    `;
      ...
      if (this.panelInfo)
        if (e.stopPropagation(), zl(this), this.panelInfo?.floating)
          Qt.updatePanel(this.panelInfo?.tag, { floating: false });
        else {
          let t;
          ...
          o === void 0 && this.panelInfo.expanded && (o = Number.parseInt(window.getComputedStyle(this).height, 10)), this.parentElement.forceClose(), Qt.updatePanel(this.panelInfo?.tag, {
            floating: true,
      ...
      this.panelInfo && (e.stopPropagation(), m.anchorLeftTop(this), Qt.updatePanel(this.panelInfo.tag, {
  ...
  connectedCallback() {
    super.connectedCallback(), this.setAttribute("role", "region"), this.reaction(
      ...
      () => {
        const e = Qt.getAttentionRequiredPanelConfiguration();
        this.toggleAttribute(yl, e?.tag === this.panelTag && e?.floating);
      }
      ...
      () => {
        requestAnimationFrame(() => {
          this.toggleAttribute(
            ...
            b$1.operationInProgress === Rl.DragAndDrop && this.panelInfo?.floating && !this.panelInfo.showWhileDragging
          );
        });
      }
    ), this.reaction(
      () => Qt.floatingPanelsZIndexOrder,
      () => {
        this.style.setProperty("--z-index-focus", `${Qt.getFloatingPanelZIndex(this.panelTag)}`);
      },
      { fireImmediately: true }
  ...
  willUpdate(e) {
    super.willUpdate(e), e.has("panelTag") && (this.panelInfo = Qt.getPanelByTag(this.panelTag), this.setAttribute("aria-labelledby", this.panelInfo.tag.concat("-title"))), this.toggleAttribute("floating", this.panelInfo?.floating);
  }
  updated(e) {
    super.updated(e), this.setCssSizePositionProperties();
  }
  firstUpdated(e) {
    super.firstUpdated(e), document.addEventListener("mouseup", this.documentMouseUpEventListener), this.headerDraggableArea.addEventListener("mousedown", this.panelHeaderMouseDownEventListener), this.toggleAttribute("expanded", this.panelInfo?.expanded), Bl(this), this.setCssSizePositionProperties(), this.contentArea.addEventListener("mousedown", this.contentAreaMouseDownListener), this.drawerResizeElement.addEventListener("mousedown", this.resizeInDrawerMouseDownListener), y(this.shadowRoot);
  }
  render() {
    return this.panelInfo ? yr`
      <div part="container">
        <div part="header" class="drag-handle">
          ${this.panelInfo.expandable !== false ? yr` <button
                part="toggle-button"
  ...
  getPopupButtonIcon() {
    return this.panelInfo ? this.panelInfo.panel === void 0 ? r$1.close : this.panelInfo.floating ? this.panelInfo.panel === "bottom" ? r$1.dockBottom : this.panelInfo.panel === "left" ? r$1.dockLeft : this.panelInfo.panel === "right" ? r$1.dockRight : w$1 : r$1.popup : w$1;
  }
  renderHelpButton() {
    return this.panelInfo?.helpUrl ? yr` <button
  ...
  changeDockingPanel(e) {
    ...
    if (this.panelInfo?.panel !== t) {
      const o = Qt.panels.filter((n) => n.panel === t).map((n) => n.panelOrder).sort((n, i) => i - n)[0];
      zl(this), Qt.updatePanel(this.panelInfo.tag, { panel: t, panelOrder: o + 1 });
    }
...
w = k([
  as("copilot-section-panel-wrapper")
], w);
$.on("undoRedo", (e) => {
  const t = e.detail.files ?? K$1();
  e.detail.undo ? $.send("copilot-plugin-undo", { files: t }) : $.send("copilot-plugin-redo", { files: t });
});
var ke = (e, t, o, n) => {
...
let Y = class extends Ss {
  ...
  render() {
    return yr`<div class="notification-tray">
      ...
      <div
        ...
        <div class="message-content">
          ...
          <div class="message-details" ?hidden="${!e.details && !e.link}">
            ${xl(e.details)}
            ${e.link ? yr`<a class="ahreflike" href="${e.link}" target="_blank">Learn more</a>` : ""}
          </div>
          ${e.dismissId ? yr`<div
...
Y = ke([
  as("copilot-notifications-container")
], Y);
function Ie(e) {
...
X ? X.add((e, t) => {
  e === "loading" && t === "connected" && b$1.active && K();
}) : console.warn("Unable to add listener for connection state changes");
$.on("copilot-plugin-state", (e) => {
  b$1.setIdePluginState(e.detail), e.detail.active && Bi("plugin-active", `${e.detail.version}-${e.detail.ide}`), e.preventDefault();
});
